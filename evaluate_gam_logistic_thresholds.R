...
logistic_methods = c('logistic5','logistic25','logistic50','logistic75','logistic95')
  ...
  for(this_sample_size in population_sample_sizes){
    for(this_percent_yes in percent_yes){
      for(this_bootstrap in 1:population_num_bootstraps){
        ...
        # Onset estimates
        for(estimator_method_name in logistic_methods){
...
write_csv(all_estimates, population_gam_logistic_threshold_results_file)
